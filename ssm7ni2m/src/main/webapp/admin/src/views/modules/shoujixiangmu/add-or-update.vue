<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺陷数量" prop="quexianshuliang">
          <el-input v-model="ruleForm.quexianshuliang" 
              placeholder="缺陷数量" clearable  :readonly="ro.quexianshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺陷数量" prop="quexianshuliang">
              <el-input v-model="ruleForm.quexianshuliang" 
                placeholder="缺陷数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目信息" prop="xiangmuxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="项目信息"
                  v-model="ruleForm.xiangmuxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmuxinxi" label="项目信息" prop="xiangmuxinxi">
                    <span>{{ruleForm.xiangmuxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shoujixiangmu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shoujixiangmuCrossAddOrUpdateFlag = false;
						 this.parent.search();
